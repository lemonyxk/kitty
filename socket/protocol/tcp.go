...
func (d *DefaultTcpProtocol) Decode(message []byte) (messageType byte, id int64, route []byte, body []byte) {
...
func (d *DefaultTcpProtocol) Encode(messageType byte, id int64, route []byte, body []byte) []byte {
	switch messageType {
	case Bin:
...
func (d *DefaultTcpProtocol) packBin(id int64, route []byte, body []byte) []byte {
