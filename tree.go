...
// func (n *node) addRoute(path string, handle *Hba) {
// 	fullPath := path
// 	n.priority++
...
// }
//
// func (n *node) insertChild(numParams uint8, path, fullPath string, handle *Hba) {
...
// // given path.
// func (n *node) getValue(path string) (handle *Hba, p Params, tsr bool) {
