...
type function func(conn *WebSocket, receive *kitty.Receive) error

type Before func(conn *WebSocket, receive *kitty.Receive) (kitty.Context, error)

type After func(conn *WebSocket, receive *kitty.Receive) error
